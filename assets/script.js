$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            case "9/6": titulo = "09 de Junho de 2022"; mensagem = "<p>Esse foi o dia que nos falamos pela primeira vez, eu indicando minha série preferida (mas já cheio de segundas intenções hehehe). </p><p>Admirava suas fotos todo santo dia, que mulher DAORA 💙</p>";break;
            case "11/6": titulo = "11 de Junho de 2022"; mensagem = "<p>O dia do primeiro migué que joguei pra puxar assunto, falando que te conhecia de algum lugar. Agora posso falar que era tudo mentira, só queria falar mais com você :3 </p>";break;
            case "14/6": titulo = "14 de Junho de 2022"; mensagem = "<p>Descobri que na real a senhorita se chamava ANNA CLARA, meu nome preferido. Apesar de você não gostar, saiba que eu gosto mto mto mto dele kkkkkk</p>";break;
            case "16/6": titulo = "16 de Junho de 2022"; mensagem = "<p>O dia que eu \"me acheguei demais\" kkkkkkkk. Tentei ser mais ousado no flerte e acabei tendo que disfarçar pra não passar vergonha.</p>";break;
            ...
            case "19/6": titulo = "19 de Junho de 2022"; mensagem = "<section class='text-center'><p class='letra-vermelha'><strong>Este momento está sendo escrito agora...</strong></p></section>";break;
